...
/**
 * This class implements the hypervolume indicator. The code is the a Java version of the original metric implementation by Eckart Zitzler. It can be used also as a command line program just by typing $java jmetal.qualityIndicator.Hypervolume <solutionFrontFile> <trueFrontFile> <numberOfOjbectives>
...
public class Hypervolume {
    ...
    /**
     * Returns the hypevolume value of the paretoFront. This method call to the calculate hipervolume one
     *
    ...
    /**
     * This class can be invoqued from the command line. Three params are required: 1) the name of the file containing the front, 2) the name of the file containig the true Pareto front 3) the number of objectives
     */

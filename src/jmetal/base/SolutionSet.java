...
public class SolutionSet implements Serializable {
  ...
  */
  ...
  public double [][] writeObjectivesToMatrix() {
    ...
    public void setCapacity(int populationSize) {
        this.capacity_=populationSize;
    }

    public Iterable<Solution> getSolutionsList() {
        return this.solutionsList_;
    }

    public void add(int i, Solution currentPoint) {
        this.replace(i, currentPoint);
    }
} // SolutionSet

...
public class Combined_Hypervolume_Catcher_4obj {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
        ...
        for (String filename : softwares) {
            ...
            for (int runs = 0; runs < runsNumber; runs++) {
                ...
                resultFront.printObjectivesToFile("resultado/" + algDir + "/" + filename + context + "/FUN_" + algDir + "-" + filename + "-" + runs + ".NaoDominadas"+ " "+ T+" "+nr);
                resultFront.printVariablesToFile("resultado/" + algDir + "/" + filename + context + "/VAR_" + algDir + "-" + filename + "-" + runs + ".NaoDominadas" + " "+ T+" "+nr);
            ...
            todasRuns.printObjectivesToFile("resultado/" + algDir + "/" + filename + context + "/All_FUN_" + algDir + "-" + filename + " " + T+" "+nr);
            todasRuns.printVariablesToFile("resultado/" + algDir + "/" + filename + context + "/All_VAR_" + algDir + "-" + filename + " " + T+" "+nr);

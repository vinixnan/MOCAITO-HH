        ...
        for (double mutationProbability : mutations) {
            for (String filename : softwares) {
                ...
                for (int runs = 0; runs < runsNumber; runs++) {
                    ...
                    resultFront.printObjectivesToFile("resultado/nsgaii_"+mutationProbability+"/" + filename + context + "/FUN_nsgaii" + "-" + filename + "-" + runs + ".NaoDominadas");
                ...
                todasRuns.printObjectivesToFile("resultado/nsgaii_"+mutationProbability+"/" + filename + context + "/All_FUN_nsgaii" + "-" + filename);

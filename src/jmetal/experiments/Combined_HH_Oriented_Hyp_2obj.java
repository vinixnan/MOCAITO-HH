...
//300 300 60000 TwoPointsCrossover SimpleInsertionMutation 30 200 OA_AJHotDraw 10
public class Combined_HH_Oriented_Hyp_2obj {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
        ...
        for (String filename : softwares) {
            ...
            for (int runs = 0; runs < runsNumber; runs++) {
                ...
                builder.initAlgs();
                HVImpChoice selector = new HVImpChoice(builder.getAlgs(), numObj, maxEvaluations, populationSize, maximumValues, minimumValues, runHH);
                AlgorithmHH algorithm;

                double oldvalues[][][] = new double[3][20][3];
                ...
                resultFront = partial;
                resultFront.printObjectivesToFile("resultado/all/" + filename + context + "/FUN_all" + "-" + filename + "-" + runs + ".NaoDominadas_HH1_" + generationsPerRound);
                resultFront.printVariablesToFile("resultado/all/" + filename + context + "/VAR_all" + "-" + filename + "-" + runs + ".NaoDominadas_HH1_" + generationsPerRound);
            ...
            todasRuns.printObjectivesToFile("resultado/all/" + filename + context + "/All_FUN_all" + "-" + filename + "_HH1_" + generationsPerRound);
            todasRuns.printVariablesToFile("resultado/all/" + filename + context + "/All_VAR_all" + "-" + filename + "_HH1_" + generationsPerRound);
        }
    }
    //  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --
}

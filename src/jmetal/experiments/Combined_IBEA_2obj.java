...
public class Combined_IBEA_2obj {
        ...
        for (double mutationProbability : mutations) {
            ...
            for (String filename : softwares) {
                ...
                for (int runs = 0; runs < runsNumber; runs++) {
                    ...
                    resultFront.printObjectivesToFile("resultado/ibea_" + mutationProbability + "/" + filename + context + "/FUN_ibea" + "-" + filename + "-" + runs + ".NaoDominadas");
                ...
                todasRuns.printObjectivesToFile("resultado/ibea_" + mutationProbability + "/" + filename + context + "/All_FUN_ibea" + "-" + filename);
